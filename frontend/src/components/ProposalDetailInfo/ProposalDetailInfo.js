...
import { formatDateCroatian, formatCurrencyEuroCroatian, formatProposalStatusCroatian } from '../../utils/formatters';
            ...
            <section className="proposal-detail-info">
                ...
                <dl className="info-grid">
                    <div className="info-item">
                        ...
                        <dd className="info-value status">{formatProposalStatusCroatian(status)}</dd>
                    </div>
                    <div className="info-item">
